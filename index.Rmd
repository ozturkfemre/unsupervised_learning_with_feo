...
However, determining number of clusters in commonly encountered data sets is too complex to be achieved simply by observing overall structure of data set with a scatter plot. For example, when scatter plot below is analyzed, it is not possible to tell how many clusters data set is divided into. 
